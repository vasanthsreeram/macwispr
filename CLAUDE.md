...
- **Stable:** **1.2.8** = GitHub Latest + Sparkle (live waveform HUD + mid-recording mic rebind) — [RELEASE_1.2.8.md](docs/context/RELEASE_1.2.8.md) (never launch repo `dist/MacWispr.app` over `/Applications`)
